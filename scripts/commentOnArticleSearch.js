...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const commentGreetingPhrases = [
      'コメント失礼します💪フォロー・スキもさせていただきました🔥',
      'コメント失礼します⚡フォローとスキもいたしました💪',
      'コメントさせていただきました🔥フォロー・スキも⚡',
      '拝見してコメントしました💪フォロー・スキもさせていただきました🔥',
      'フォロー・スキさせていただきました🔥コメント失礼します💪',
      'フォロー・スキもさせていただきました⚡コメント失礼します💪',
      'フォローとスキもしました💪コメント失礼します🔥',
    ];
    ...
    const additionalPrompt = `一般的な30台男性の口調で書いてください。
...
`;
    ...
    const additionalSystemMessage = `あなたは一般的な30台男性ユーザーです。
