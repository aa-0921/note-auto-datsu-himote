...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const patterns = [
      ...
      '【男勝り女性必見】ガサツ女子が求める男性像',
      '【男勝り×おとなしい】ガサツ女性との意外な相性',
      '【男勝り女性攻略】ガサツ女子とのデート術',
      '【男勝り女性攻略】ガサツ女子との会話術',
