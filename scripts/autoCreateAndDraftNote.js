...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const articleConditionsLines = [
      ...
      '',
      '5. 有料項目紹介セクション：',
      '・有料部分の直前に「この記事を読むことで、あなたは以下の4つを知ることができます。」を配置',
      '・①、②、③、④の記号で4つの価値を提示',
      '・重要：ここのタイトルと有料部分のタイトルをあわせる',
      ...
      '・無料部分で約束した4つの価値と有料部分の内容が完全に一致すること',
      '・無料部分で「この記事を読むことで、あなたは以下の4つを知ることができます」で提示した内容を、有料部分でそのまま提供すること',
      '・有料部分のタイトルは、無料部分の「有料項目紹介セクション」で提示した4つのタイトルをそのまま使用すること',
      '・有料部分の各セクションのタイトルは「## タイトル」の形式で記述すること',
      '・実践的で即効性のある内容',
      ...
      '',
      '【重要】無料部分と有料部分の内容一致：',
      '・無料部分で約束した4つのポイントのタイトルと内容を、有料部分でそのまま使用すること',
      '・無料部分の「有料項目紹介セクション」で提示した4つのタイトルを、有料部分の見出しとしてそのまま使用すること',
